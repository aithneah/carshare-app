...
class DriverDatesScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            weekdays: [],
    ...
    render() {
        return <View style={styles.driverMapsContainer}>
            ...
            <View style={styles.driverWaypointsProgressBar}>
                <Text style={styles.driverWaypointsProgressBarText}>KROK 3 Z 4: WYBÓR TERMINÓW</Text>
            </View>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('DriverPrefferences', {
...
export default DriverDatesScreen;
