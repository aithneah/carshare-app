...
class PassengerOverviewScreen extends Component {
    render() {
        return <View style={styles.allRoutesScreenContainer}>
            ...
            <View style={styles.allRoutesScreenContent}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('PassengerWaypoints')} style={styles.plusButton}>
                    <View>
...
export default PassengerOverviewScreen;
